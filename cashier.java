...
public class cashier extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/inventry","root","");
            pst = con1.prepareStatement("insert into cashier (user_name,password,status)values(?,?,?)");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtuser.setText(d1.getValueAt(seclectIndex, 1).toString());
        //txtpass.setText(d1.getValueAt(seclectIndex, 1).toString());
        txtstatus.setSelectedItem(d1.getValueAt(seclectIndex, 2).toString());
        txtpass.setText(d1.getValueAt(seclectIndex, 3).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/inventry","root","");
            pst = con1.prepareStatement("update cashier set USER_NAME=?, PASSWORD=?,STATUS=? where ID= ?");
            pst.setString(1, user);           
            pst.setString(2, pass);
            pst.setString(3, status);
            pst.setInt(4, id);
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null,"USER ID Updated");
            table_update();
            txtuser.setText("");
            txtpass.setText("");
            txtstatus.setSelectedIndex(-1);
